...
function Footer() {
  return (
    <footer className=" h-18  bottom-0 left-0  bg-blue-100/80 font-sans dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            {/* <div>
                ...
                <div className="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <p className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Rider</p>
                    <p className="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">Driver</p>
                </div>
            </div> */}
        ...
        <div className="sm:flex sm:items-center sm:justify-between ">
            ...
            <div className="flex gap-4 items-center justify-center hover:cursor-pointer">
        ...
        <p className="text-black font-sans p-8 text-start md:text-center md:text-lg md:p-4">© 2024 Safar Inc. All rights reserved.</p>
    </div>
</footer>
  )
}
